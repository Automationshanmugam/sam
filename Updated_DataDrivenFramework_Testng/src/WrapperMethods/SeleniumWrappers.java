...
public class SeleniumWrappers
{
	...
	for (WebElement FetchUIObject : select){
	if (FetchUIObject.getAttribute("waitForElementPresent") != null)
	//radio.clickOn();
	FetchUIObject(locator).click();
	}}
	...
	public static List<WebElement> FetchUIObjects(By locator) throws Exception
	{
		return driver.findElements(locator);
   		
	}
	 //////////////////////////  Find UI Object with By locator ////////////////////////
	public static WebElement FetchUIObject(By locator) throws Exception
	{
    ...
    public static String getValue(By locator) throws Exception
	{
		...
		return FetchUIObject(locator).getAttribute("value");
	}
	 //////////////////////////  Read text from UI Object  ////////////////////////
    ...
    public static String getText(By locator) throws Exception
	{
		...
		return FetchUIObject(locator).getText();
	}
	...
	public static void enterData(By locator,String waitForElementPresent) throws Exception
	{
		...
		FetchUIObject(locator).sendKeys(waitForElementPresent);
	...
	public static void pressKey(By locator,Keys key) throws Exception
	{
		...
		FetchUIObject(locator).sendKeys(key);
	...
	{
		return new Select(FetchUIObject(locator)).getFirstSelectedOption().getText();		
	}
	...
	public static void waitTime(final int iTimeInMillis)
	{
	    try
	    {
	...
	public static boolean isAlertPresent()
	{
		...
		//////////////////To refresh the page/////////////////////////////////////////////
		 ...
		 public static void verifyTextPresent(String text)
		 {
			 try
			 {
			  FetchUIObject(By.xpath("//*[contains(.,'"+text+"')]"));
			 }catch (Exception e) 
			 {
